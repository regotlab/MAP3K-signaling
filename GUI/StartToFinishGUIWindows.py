...
import sys
sys.path.append(r'C:\Users\RegotLab\ImageAnalysisPython\ImageAnalysis_122\ImageAnalysisNew\ImageAnalysisPython')

from src.preprocessImages import preprocessImagesCaller
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.objectList.setPlainText('nuclei,cytoring')
...
def StructUpdate(self):
    ...
    self.BigStruct['concatPos'] = self.groupBox.isChecked()
    self.BigStruct['PosPerWell'] = self.spinBox_6.value()
    ...
    self.BigStruct['mitosis'] = self.checkBox_15.isChecked()
...
def mainRunner(self):
    if self.BigStruct['testModeOn'] == False:
        if self.BigStruct['reOrg']:
            ...
            if self.BigStruct['concatPos'] and self.BigStruct['PosPerWell']:
                PosStruct = {}
                PosStruct['concatPos'] = self.BigStruct['concatPos']
                PosStruct['PosPerWell'] = self.BigStruct['PosPerWell']
                PosStruct['ImgDir'] = self.BigStruct['ReOrgOut']
                PosStruct['Ch'] = self.BigStruct['channels'] 
                PosCat(PosStruct)
        if self.BigStruct['preprocess']:
            preprocessingStruct = {}
        ...
        if self.BigStruct['cellprofiler']:
            ...
            callCommand = ['python', r'C:\Users\RegotLab\ImageAnalysisPython\ImageAnalysis_122\ImageAnalysisNew\ImageAnalysisPython\src\cpBatch.py', 
