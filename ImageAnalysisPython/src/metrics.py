...
def pred_to_label(pred, cell_min_size, cell_label=1):
    ...
    [labelcell, num1] = skimage.morphology.label(cell, return_num=True,connectivity=1)
    cell = skimage.morphology.remove_small_objects(labelcell, min_size=cell_min_size,connectivity=1)
    # label cells only
