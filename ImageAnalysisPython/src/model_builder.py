...
def get_core(dim1, dim2):
    ...
    a = tf.keras.layers.Conv2D(64, (3, 3), **option_dict_conv)(x)  
    a = tf.keras.layers.BatchNormalization(**option_dict_bn)(a)

    a = tf.keras.layers.Conv2D(64, (3, 3), **option_dict_conv)(a)
    a = tf.keras.layers.BatchNormalization(**option_dict_bn)(a)

    
    y = tf.keras.layers.MaxPooling2D()(a)

    b = tf.keras.layers.Conv2D(128, (3, 3), **option_dict_conv)(y)
    b = tf.keras.layers.BatchNormalization(**option_dict_bn)(b)

    b = tf.keras.layers.Conv2D(128, (3, 3), **option_dict_conv)(b)
    b = tf.keras.layers.BatchNormalization(**option_dict_bn)(b)

    
    y = tf.keras.layers.MaxPooling2D()(b)

    c = tf.keras.layers.Conv2D(256, (3, 3), **option_dict_conv)(y)
    c = tf.keras.layers.BatchNormalization(**option_dict_bn)(c)

    c = tf.keras.layers.Conv2D(256, (3, 3), **option_dict_conv)(c)
    c = tf.keras.layers.BatchNormalization(**option_dict_bn)(c)

    
    y = tf.keras.layers.MaxPooling2D()(c)

    d = tf.keras.layers.Conv2D(512, (3, 3), **option_dict_conv)(y)
    d = tf.keras.layers.BatchNormalization(**option_dict_bn)(d)

    d = tf.keras.layers.Conv2D(512, (3, 3), **option_dict_conv)(d)
    d = tf.keras.layers.BatchNormalization(**option_dict_bn)(d)
    ...
    e = tf.keras.layers.Conv2D(256, (3, 3), **option_dict_conv)(y)
    e = tf.keras.layers.BatchNormalization(**option_dict_bn)(e)

    e = tf.keras.layers.Conv2D(256, (3, 3), **option_dict_conv)(e)
    e = tf.keras.layers.BatchNormalization(**option_dict_bn)(e)
    ...
    f = tf.keras.layers.Conv2D(128, (3, 3), **option_dict_conv)(y)
    f = tf.keras.layers.BatchNormalization(**option_dict_bn)(f)

    f = tf.keras.layers.Conv2D(128, (3, 3), **option_dict_conv)(f)
    f = tf.keras.layers.BatchNormalization(**option_dict_bn)(f)
    ...
    y = tf.keras.layers.Conv2D(64, (3, 3), **option_dict_conv)(y)
...
def get_model_3_class(dim1, dim2, activation="softmax"):
    ...
    y = tf.keras.layers.Conv2D(3, (1, 1), **option_dict_conv)(y)
