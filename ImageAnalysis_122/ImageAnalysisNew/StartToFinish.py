...
preProcess = False #Flatfield, Neural Net, Register
cellprofiler = True #run CellProfiler
tracking = True #this is useless currently
...
reOrgOutput = r'C:\LocalAnalysisC\Tim\201108\Cell_Cycle_Test\RawImages' #Local Analysis Folder
preprocessingInput = r'C:\LocalAnalysisC\Tim\201108\Cell_Cycle_Test\RawImages'#leave empty to default to ReOrgOutput
preprocessingOutput = r'C:\LocalAnalysisC\Tim\201108\Cell_Cycle_Test\Images3'
...
preprocessingStruct['startFlatfieldPos'] = 60 #only necessary if not using single frame
preprocessingStruct['endFlatfieldPos'] = 62 #only necessary if not using single frame
