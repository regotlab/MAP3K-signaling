...
##############
####Universal Variables
Channels = ["Far-red","TRITC","YFP","CFP"]
CPU_NUM = 60 #0 will consider all, CAP IT AT 60 IF YOUR COMPUTER HAS 64+ OR ELSE EVERYTHING BREAKS
quite = False

####Folders
reOrgInput = r'X:\ScopeData\Images\Tim\201102\cTA340_BRAF_V60E_CDKKTR_TC'
reOrgOutput = r'C:\LocalAnalysisC\Tim\201102\cTA340_BRAF_V60E_CDKKTR_TC\RawImages'
preprocessingInput = r'C:\LocalAnalysisC\Tim\201102\cTA340_BRAF_V60E_CDKKTR_TC\RawImages'#leave empty to default to ReOrgOutput
preprocessingOutput = r'C:\LocalAnalysisC\Tim\201102\cTA340_BRAF_V60E_CDKKTR_TC\Images'
cellprofilerInput = r'C:\LocalAnalysisC\Tim\201102\cTA340_BRAF_V60E_CDKKTR_TC\Images' #leave empty to default to preprocessingOutput
cellprofilerOutput = r'C:\LocalAnalysisC\Tim\201102\cTA340_BRAF_V60E_CDKKTR_TC\Output'

####REORG
ReOrgStruct = {}
ReOrgStruct['EP'] = 'Exp0' #Experiment Prefix"
...
ReOrgStruct['LastImg'] = 564 #will default to final frame of ExpPrefix.
ReOrgStruct['LastPos'] = 58 #will default to final position of ExpPrefix.
...
preprocessingStruct['startFlatfieldPos'] = 54 #only necessary if not using single frame
preprocessingStruct['endFlatfieldPos'] = 57 #only necessary if not using single frame
...
preprocessingStruct['neuralNetModelPath'] = r'C:\Users\Tim\Documents\ImageAnalysis\NNs\model.hdf5' #filepath to keras .hdf5 model file
